...
Show this with text replacement for w, x, y, z
_very_ carefully.  To demonstrate it very carefully.
  ...
  internal static QuaternionRec Multiply(
    ...
    // If W was set to zero then this is the same
    ...
    // This part is the same as a dot
    // product, but with negative parts.
    // Is it a right- or left-handed coordinate
    // system?  Hamilton used left-handed.
